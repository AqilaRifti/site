    ...
    <NuxtLayout :name="layout">
        <main class="soal">
            ...
            <UContainer>
                ...
                <UTextarea color="primary" v-model="essay" variant="outline" placeholder="Describe yourself as detail as possible in here" style="margin-top: 0.5rem!important;margin-bottom: 0.5rem!important" />
...
async function getQuestions() {
    ...
    const response: any = await $fetch("https://api.fireworks.ai/inference/v1/chat/completions", {
        ...
        body: JSON.stringify({
            ...
            frequency_penalty: 0,
            temperature: 0.6,
            messages: [{"role": "user", "content": `(Respond in Indonesian Language) Make ${questionCount.value} multiple choice MBTI questions with options in json format like this ${questionJsonFormat} and please response in pure json no text outside of the json`}]
        })
    });
